...
def _create_network_data(
    ...
    static_info = StaticNetworkInformation(
        injection_limit_active_power_min=injections["min_p"].to_numpy(dtype=float),
        injection_limit_active_power_max=injections["max_p"].to_numpy(dtype=float),
        injection_limit_reactive_power_min=injections["min_q"].to_numpy(dtype=float),
        injection_limit_reactive_power_max=injections["max_q"].to_numpy(dtype=float),
    ...
    dynamic_info = DynamicNetworkInformation(
        ...
        bus_voltage_magnitude_setpoint=buses["voltage_magnitude"].to_numpy(dtype=float),
        ...
        injection_voltage_regulation=injections["voltage_regulation"].to_numpy(dtype=bool),
        injection_regulated_bus=injections["regulated_bus_id_int"].to_numpy(dtype=int),
    ...
    network_info = NetworkInformation(
        static_network_data=static_info,
        dynamic_network_data=dynamic_info,
        string_network_data=string_info,
    )
    return network_info
